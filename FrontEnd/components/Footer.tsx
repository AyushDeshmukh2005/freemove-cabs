    ...
    <footer className="bg-gray-100 dark:bg-gray-800 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">GoCabs</h3>
            <p className="text-gray-600 dark:text-gray-300">
              Revolutionizing the way you travel with innovative ride-hailing solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/press" className="text-gray-600 dark:text-gray-300 hover:text-primary">Press</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/contact" className="text-gray-600 dark:text-gray-300 hover:text-primary">Contact Us</Link></li>
              <li><Link to="/safety" className="text-gray-600 dark:text-gray-300 hover:text-primary">Safety</Link></li>
              <li><Link to="/covid" className="text-gray-600 dark:text-gray-300 hover:text-primary">COVID-19 Resources</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/cookies" className="text-gray-600 dark:text-gray-300 hover:text-primary">Cookie Policy</Link></li>
              <li><Link to="/licensing" className="text-gray-600 dark:text-gray-300 hover:text-primary">Licensing</Link></li>
            </ul>
          </div>
        </div>
